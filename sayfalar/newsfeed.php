...
<?php                
$sql = $db->query("SELECT n.ID, n.DURUM, n.ICERIK, k.ADSOYAD,n.ETAR, n.EKUL, n.DTAR, n.DKUL  FROM newsfeed n,kullanici k where k.ID=n.EKUL order by id desc");
...
<div class="box box-solid" >
    ...
    <div class='box-header with-border'>
        ...
        <span class='direct-chat-timestamp pull-right'><?php echo date("d/m H:i:s",strtotime($newsfeedsql['ETAR'])); ?></span>
    </div >
    <div class="box-body">
